          ...
          <div className="mt-5 flex items-center gap-2">
            {member.linkedin && (
              <motion.a
                ...
                className="focus-ring inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/12 bg-white/[0.06] text-slate-300 transition-all hover:bg-white/[0.14] hover:text-white hover:shadow-[0_0_16px_rgba(96,165,250,0.15)]"
