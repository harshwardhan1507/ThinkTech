...
export const events: Event[] = [
  ...
  },
  {
    ...
    description:
      "An interdisciplinary discussion exploring the evolving relationship between humans and artificial intelligence. Participants debated the role of AI in decision-making, creativity, productivity, and ethics while strengthening analytical thinking and public speaking skills.",
    date: "April 2026",
  ...
  },
  {
    ...
    description:
      "A competitive debate examining one of the most pressing questions in modern technology: should artificial intelligence be developed for warfare, or is it inherently unethical? Teams presented evidence-based arguments while engaging with the societal implications of emerging technologies.",
    date: "September 2025",
    format: "Debate Competition",
    audience: "Engineering Students",
